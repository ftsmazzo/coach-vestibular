...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|api/admin/provas/[^/]+/extrair|api/admin/provas/[^/]+/extrair-hibrido|api/admin/provas/[^/]+/questoes|api/admin/provas/[^/]+/texto-fonte|api/admin/provas/[^/]+/pipeline).*)",
  ],
};
